...
const Sidebar = () => {
    ...
    const handleNavigation = (path) => {
        ...
        if (window.innerWidth < 1024) {
            // Your mobile sidebar close logic here
        }
    };
    ...
    return (
        <aside 
            id="sidebar"
            className="sidebar-visible relative inset-0 lg:inset-auto mx-auto my-0 
                    sm:w-[90vw] md:w-[300px] 
                    h-fit lg:h-[100%]
                    dark:bg-[#121212] bg-[#ffffff] 
                    p-5 z-40 
                    sm:border border-gray-300 border-[#333] 
                    transition-all duration-300 ease-in-out 
                    sm:rounded-b-[4px]  lg:border-none lg:rounded-b-none
