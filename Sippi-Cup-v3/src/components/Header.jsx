...
const Header = ({ onSearch }) => {
    ...
    const handleToggleSidebar = () => {
        ...
        // The actual toggle is handled by the layout context
    };

    // Update lock icons based on sidebar state
    useEffect(() => {
        ...
        <div className="top-0 left-0 right-0 bg-[#fff] dark:bg-[#121212] w-full h-fit px-5 py-2 relative flex-1 flex items-center justify-between z-50 border-b border-[#333]">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <svg 
                        id="open-lock" 
                        className="ml-1 md:ml-6 fill-[#000] dark:fill-[#b3b3b3] cursor-pointer hidden" 
                ...
                <div className="flex items-center">
                    <img 
                        width="200px" 
                        className="hidden dark:flex lg:ml-[40px]" 
                        src="/src/assets/SippiCupPod Logo Dark NoBG.png" 
                        alt="SippiCup full logo dark"
                    />
                    <img 
                        className="dark:hidden block lg:ml-[40px]" 
                        width="200px"  
                        src="/src/assets/SippiCupPod Logo Light NoBG.png" 
                        alt="SippiCup full logo light"
                    />
                </div>
            </div>
