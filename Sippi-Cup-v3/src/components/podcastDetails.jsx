...
const PodcastDetail = () => {
    ...
    return (
        <div className="min-h-screen dark:bg-[#121212] dark:text-[#fff] bg-[#f4f4f4] text-[#000] p-4 md:p-8">
                    ...
                    <>
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                            ...
                            <select 
                                ...
                                className="w-[300px] px-2 py-2 font-plus-jakarta-sans border text-[13px] font-medium border-gray-300 rounded-md shadow-sm text-[#000112] focus:outline-none focus:ring-2 focus:ring-[#65350F] text-sm"
                            >
                        ...
                        {selectedSeason && (
                            <div className="mb-8">
                                {/* Season Header */}
                                <div className="flex items-start space-x-4 p-4 dark:bg-[#181818] hover:bg-[#282828] bg-[#fff] rounded-lg mb-6">
                                    <img 
                                        src={selectedSeason.image || podcastData.image || "/src/assets/SippiCup_logo.png"} 
                        ...
                        {currentSeasons.length > 1 && (
                            <div className="mt-8">
                                <h5 className="text-lg font-medium dark:text-white text-[#000] mb-4">All Seasons</h5>
                                    ...
                                    {currentSeasons.map((season) => (
                                        <div 
                                            ...
                                            className={`p-4 hover:bg-[#282828] bg-[#fff] dark:bg-[#181818] rounded-lg cursor-pointer dark:hover:bg-[#282828] transition-colors ${
                                                selectedSeason?.season === season.season ? 'ring-4 ring-[#65350F]' : ''
                                            }`}
