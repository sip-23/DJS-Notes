...
const GenreFilter = ({ onGenreChange }) => {
    ...
    const fetchAllGenres = async () => {
        ...
        try {
            // Since we don't have a bulk endpoint, we'll fetch the known genre IDs
            const genreIds = [1, 2, 3, 4, 5]; // Based on your API structure
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-start gap-3 mb-6 mt-6">
                <h4 className="font-medium dark:text-[#fff] text-[#000] text-[15px]">Filter by:</h4>
